...
export const LinksPage: React.FC<LinksPageProps> = ({
  ...
  const linksParallaxTransform = React.useMemo(() => {
    if (!mousePosition) return "translate3d(0, 0, 0)";
    return calculateParallaxTransform(
      linksRef.current,
      mousePosition,
      0.02,
      15,
  ...
  React.useEffect(() => {
    ...
    if (scrollElement) {
      ...
      if (logoElement && !isMobile) {
        logoElement.addEventListener("wheel", handleLogoWheel, {
          passive: false,
        });
      }
            ...
            >
              <h2
                ...
                style={{
                  ...
                  transition: allButtonsStagger.items[0]?.transition ?? "none",
                }}
              >
                FOLLOW US
              </h2>
                  ...
                  <SocialLinkButton
                    ...
                    style={{
                      ...
                      transform:
                        ...
                        "translateY(20px) scale(0.95)",
                      transition:
                        allButtonsStagger.items[index + 1]?.transition ??
                        "none",
                    }}
                  />
                ))}
            ...
            >
              <h2
                ...
                style={{
                  ...
                  transform:
                    ...
                    "translateY(20px) scale(0.95)",
                  transition: allButtonsStagger.items[3]?.transition ?? "none",
                }}
              >
                GET TICKETS
              </h2>
              <GestureWrapper
                longPress={{
                  ...
                  handlers: {
                    onLongPress: () => {
                      navigator.clipboard.writeText("https://hdfst.uk/e138426");
                      toast({
                        title: "Ticket Link Copied!",
                        description:
                          "Headfirst ticket link copied to clipboard",
                        duration: 2000,
                      });
                    },
                  },
                ...
                style={{
                  ...
                  transform:
                    ...
                    "translateY(20px) scale(0.95)",
                  transition: allButtonsStagger.items[4]?.transition ?? "none",
                }}
              >
                <Button
                  ...
                  onClick={() =>
                    window.open("https://hdfst.uk/e138426", "_blank")
                  }
                  ripple={true}
                  magnetic={true}
                  clickAnimation={true}
              ...
              <h2
                ...
                style={{
                  ...
                  transform:
                    ...
                    "translateY(20px) scale(0.95)",
                  transition: allButtonsStagger.items[5]?.transition ?? "none",
                }}
              >
                MERCH STORE
              </h2>
              <GestureWrapper
                ...
                style={{
                  ...
                  transform:
                    ...
                    "translateY(20px) scale(0.95)",
                  transition: allButtonsStagger.items[6]?.transition ?? "none",
                }}
              >
                <Button
                  ...
                  onClick={() =>
                    window.open("https://merch.wibblywobblaz.xyz", "_blank")
                  }
                  ripple={true}
                  magnetic={true}
                  clickAnimation={true}
